...
plotSEMS = function(method = "tree2", szM = 13, szL = 10){
  ...
  title("A", outer = TRUE, line = -1,
        adj = 0.05, cex.main = .8)
  title("B", outer = TRUE, line = -1,
        adj = 0.55, cex.main = .8)
  title("C", outer = TRUE, line = -8,
        adj = 0.05, cex.main = .8)
  title("D", outer = TRUE, line = -8,
        adj = 0.55, cex.main = .8)
  title("E", outer = TRUE, line = -15,
        adj = 0.05, cex.main = .8)
  title("F", outer = TRUE, line = -15,
        adj = 0.55, cex.main = .8)
}

png("../_manuscript/_figs/factor_tree.png", 
    width = 800, 
    height = 800, 
    res = 300)  
plotSEMS(
